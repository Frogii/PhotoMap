...
import com.example.photomap.util.Constants.PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE
        ...
        fun requestAllPermissions(context: Context){
            ActivityCompat
                .requestPermissions(
                    ...
                    arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.WRITE_EXTERNAL_STORAGE),
                    PERMISSIONS_REQUEST
                )
        }
